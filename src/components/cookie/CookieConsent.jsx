...
const CookieConsent = () => {
    ...
    const handleAccept = () => {
        setCookie('userConsent', 'accepted', 7); // Sets 'userConsent' cookie for 7 days
        setShowModal(false);
    };
    const handleReject = () => {
        // setCookie('userConsent', 'accepted', 7); // Sets 'userConsent' cookie for 7 days
    ...
    return (
        <>
            <div
                class="w-full max-w-3xl flex flex-col md:flex-row items-start md:items-center justify-between gap-8 bg-slate-600 p-5 rounded-xl"
            >
                <svg
                ...
                <div>
                    <h4 class="text-white font-bold text-base">We use cookies</h4>
                    <p class="text-white text-xs mt-2 md:mt-1">
